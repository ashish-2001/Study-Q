...
function organizeAnswers(answers: Answer[], parentId: number): Answer[]{
...
async function fetchAnswersForQuestion(sessionId: string, slug: string, searchParams: QueryParams){
    let  orderCriteria = {};
    ...
    return questionWithAnswers ? organizeAnswers(questionWithAnswers.answers, null) : [];
};

async function SingleAnswerPage({ params, searchParams }: { params: { slug: string }; searchParams: QueryParams }){
    ...
    const answers = await fetchAnswersForQuestion( session?.user.id, params.slug, searchParams);
    ...
    return (
        <div className='wrapper flex flex-col gap-8'>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align='end' className='w-[200px]'>
                        <DropdownMenuRadioGroup value={tabType}>
                            <Link href={getUpdatedUrl(`/question/${params.slug}`, searchParams, {
                                tabtype: TabType.mu
                            })}>
            ...
            <div className='flex lex-col items-center justify-center gap-4 px-4'>
