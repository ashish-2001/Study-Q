...
import { Cuboiid, PackagePlus } from 'lucide-react';
        ...
        <div className='wrapper my-16 flex flex-col gap-4'>
            ...
            >
                <AccordionItem value='add-new-course'>
                    ...
                    <AccordionContent>
                        <div className='grid w-full grid-cols-1 lg:grid-cols-7'>
                            <div className='col-span-1 text-sm font-semibold text-gray-400 lg:col-span-2'>
                                Create new course for study-q community and let user explore new courses
                            </div>
                ...
                <AccordionItem className='border-none' value='discord-config'>
                    ...
                    <AccordionContent>
                        <div className='grid w-full grid-cols-1 lg:grid-cols-7'>
                            <div className='text-gray-400 col-span-1 p-6 text-sm font-semibold lg:colspan-2'>
