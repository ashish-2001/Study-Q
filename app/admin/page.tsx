        ...
        return (
            ...
            >
                <Link 
                    ...
                    className='group relative flex h-[15rem] w-full cursor-pointer flex-col items-center overflow-hidden rounded-lg border-2 p-4 transition-all duration-200 ease-linear hover:border-blue-500'
                >
