...
import { QuestionDeleteSchema, QuestionInsertSchema, QuestionUpdateSchema } from "./schema";
...
export type InputTypeUpdate = z.infer<typeof QuestionUpdateSchema>;
export type ReturnTypeUpdate = ActionState<InputTypeUpdate, Question>;
