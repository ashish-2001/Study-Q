    ...
    return (
        <div className='flex min-h-[24vh] items-center overflow-clip rounded-xl'>
            ...
            <div className='relative flex h-full flex-grow flex-col items-center justify-center'>
                ...
                <p className='sm:text-md flex-wrap whitespace-normal text-wrap rounded-full border-black bg-gray-400/20 px-3 text-center text-xs capitalize text-white sm:text-lg lg:text-sm '>
                    {secondPart}
                </p>
                {!secondPart && (
            ...
            <div className='absolute bottom-4 right-4 flex items-center justify-center'>
                {type === 'video' && contentDuration !== undefined && (
                    <div className='rounded-full bg-gray-400/20 px-2 py-1'>
