...
const useMediaQuery = (query: string): boolean => {
    ...
    useEffect(() => {
        const meadia = window.matchMedia(query);
    ...
    return (
        <>
            <motion.nav
                ...
                className="fixed left-2 top-0 z-[999] hidden h-full flex-col border-r border-primary/10 bg-background dark:bg-background lg:flex min-w-16"
            >
                <div className='flex h-full flex-col gap-4'>
                    <div className='flex w-full items-center border-4 border-primary/10 px-2 py-4'>
                        <div>
                            <motion.button
            ...
            >
                <div className='flex items-center justify-center border-t border-primary/10 bg-background p-4 shadow-xl'>
