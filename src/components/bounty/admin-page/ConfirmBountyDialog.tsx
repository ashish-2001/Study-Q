...
export const ConfirmBountyDialog: React.FC<ConfirmBountyDialogProps> = ({
    ...
    const [amount, setIsAmount] = useState<string>('');
    ...
    const handleConfirm = () => {
        ...
        if(!isNaN(parsedAmount)){
            ...
            toast.error('Error a valid Amount');
        };
            ...
            <DialogContent>
                ...
                <div className='mt-2 flex items-center'>
                    ...
                    <Input
                        ...
                        className="ml-2 block w-full rounded border px-4 py-2 focus:outline-none"
