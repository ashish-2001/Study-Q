...
const heroItmes = [
    {
        imageUrl: 'https://appxcontenr.kaxa.in/paid_cpurse3 /2024-07-07-0.8201249093606604.png'
    },
    {
        imageUrl: 'https://100k-b-mcdn.akamai.net.in/images/adhoc.jpeg'
    },
    {
    ...
    {
        imageUrl: 'https://appxcontent.kaxa.n/paid_course3/2024-07-09-0.6125162399767927.png'
    }
];
        ...
        <div className="flex min-h-screen flex-col">
            <main className="flex h-full flex-col items-center justify-center gap-2">
                <motion.div
                    ...
                    transition={{ duration: 0.5, delay: 0.25, type: 'spring', damping: 10, stiffness: 100 }}
                    className="flex max-w-7xl flex-col items-center justify-center gap-2 px-4"
                >
                    <h1 className="max-w-2xl py-2 pt-36 text-center text-5xl font-extrabold tracking-tighter md:text-6xl xl:text-2xl">
                ...
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y:0 }}
                    transition={{ duration: 0.5, delay: 0.5, type: 'spring', damping: 10, stiffness: 100 }}
