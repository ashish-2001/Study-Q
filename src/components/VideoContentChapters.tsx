                            ...
                            <TooltipProvider>
                                <Tooltip>
                                    <div key={`${index}-${start}${end}${title}`}>
                                        <div 
                                            className={`flex max-w-64 cursor-pointer items-center justify-between gap-2 rounded-lg p-4 transition-all duration-300 hover:bg-primary/10 ${currentTime >= start && currentTime < end ? 'bg-blue-5' : ''}`}
                                            onClick={() => {
                                        ...
                                        >
                                            ...
                                            <span className='rounded-full bg-blue-500/20 px-2 py-1 fot-medium text-blue-500'>
                                                {formatTime(start)}
                                            </span>
                                        </div>
                                    </div>
