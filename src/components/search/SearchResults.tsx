import { TSearchVideos } from "@/src/app/api/mobile/search/route";
...
export function SearchResults({ isVisible, isMobile, searchTerm, loaing, searchedVideos, selectedIndex, onCardClick }: SearchResultsProps){
    ...
    return (
        <div className={`absolute ${isMobile ? 'top-full' : 'top-12'} z-30 max-h-[40vh] w-full overflow-y-scroll rounded-lg border-2 bg-background p-2 shadow-lg`}>
            {renderSearchResults()}
        </div>
    )
};