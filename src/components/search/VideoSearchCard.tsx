...
import { TSearchedVideos } from "@/src/app/api/search/route";
...
const VideoSearchCard: React.FC<VideoSearchCardProps> = ({
    ...
    if(parentId && parent?.courses.length){
        ...
        return (
            <Link href={videoUrl} className="group relative flex cursor-pointer items-center gap-3 rounded-md px-3 py-2 hover:bg-blue-600/10 hover:text-blue-600" onClick={handleClick}>
