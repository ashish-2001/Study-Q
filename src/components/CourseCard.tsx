            ...
            <CardContent className='p-4'>
                ...
                <div className='flex space-x-2'>
                    ...
                    {course.certIssued ? (
                        ...
                        <Link className='flex-1 inline-flex items-center justify-center rounded-md py-2 text-sm font-medium text-primary underline-offset-4 ring-offset-background transition-colors hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50' href={course.discordOauthUrl} target='blank'>
                            <MessageCircle/>
                            Join Discord
                        </Link>
                    )}
