...
export const NewPostDialog = () => {
    ...
    const handleOnCloseClick = () => {
        router.push(getUpdateUrl(`${path}/`, paramsObject, { newPost: 'close' }));
            ...
            <AnimatePresence>
                <form ref={formRef} onSubmit={onSubmit}>
                    <motion.div
                        ...
                        className="fixed inset-0 mx-auto flex w-full max-w-screen-md items-center p-4 md:max-w-4xl md:p-8"
                    >
                        <div
                            ref={containerRef}
