...
export type ReturnTypeCreateComment = ActionState<InputTypeCreateComment, Comment>;

export type InputTypeUpdateComment = z.infer<typeof CommentUpdateSchema>;
export type ReturnTypeUpdateComment = ActionState<InputTypeUpdateComment, Comment>;

export type InputTypeApproveIntroComment = z.infer<typeof CommentApproveIntroSchema>;
export type ReturnTypeApproveIntroComment = ActionState<InputTypeApproveIntroComment, Comment>;

export type InputTypeDeleteComment = z.infer<typeof CommentDeleteSchema>;
export type ReturnTypeDeleteComment = ActionState<InputTypeDeleteComment, Delete>
